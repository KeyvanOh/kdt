  ...
  //let characterPositions = [195, 220];
  //let gridNumberHeavyOld = gridNumberHeavy;
  //let
  d.ready(function () {
    let body = $("main");
    ...
    setInterval(function () {
      ...
      */
      ...
      for (k of keys) {
        ...
        //gridNumberHeavyOld = gridNumberHeavy;
      ...
      /*
      $(".grid" + gridNumberHeavy).css("background", "rgb(128, 0, 0)");
      if (gridNumberHeavy != gridNumberHeavyOld) {
        $(".grid" + gridNumberHeavyOld).css("background", "transparent");
      }
      console.log(`${gridNumberHeavy}, ${gridNumberHeavyOld}`);
      */
