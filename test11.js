  ...
  //let leftMovedGuess = -64 * (gridNumberHeavy % 16);
  //let topMovedGuess = 64 * (15 - Math.floor(gridNumberHeavy / 16));
    ...
    setInterval(function () {
      ...
      for (k of keys) {
        ...
        if (leftMoved > 0 && leftMoved < 32) {
          ...
          //if (-leftMoved - (gridNumber % 16) * 64 > 64) {
          //if (gridNumber % 16 != 0) {
      ...
      //console.log(`${top}, ${left}, ${topMoved}, ${leftMoved}`);
      //console.log(`${left}, ${top}, ${leftMoved}, ${topMoved}`);
      //let gridNumberGuess = 240;
      //let leftMovedGuess = 0;
      //let leftMovedGuess = gridNumberHeavy - 240;
      //let leftMovedGuess = (gridNumberHeavy - 240) * -64;
      //let leftMovedGuess = (gridNumberHeavy - 240) * -64;
      //let gridNumberHeavyQuotient = Math.floor(gridNumberHeavy / 16);
      //let gridNumberHeavyRemainder = gridNumberHeavy % 16;

      //let leftMovedGuess = -64 * gridNumberHeavyRemainder;
      let leftMovedGuess = -64 * (gridNumberHeavy % 16);
      //let leftMovedGuess = (240 - gridNumberHeavy) * 64;
      //let leftMovedGuess = ((240 - gridNumberHeavy) * 64) % 1024;
      //let topMovedGuess = 64 * gridNumberHeavyQuotient;
      //let topMovedGuess = 64 * (15 - gridNumberHeavyQuotient);
      let topMovedGuess = 64 * (15 - Math.floor(gridNumberHeavy / 16));

      console.log(
        //`${left}, ${top}, ${leftMoved}, ${topMoved}, ${gridNumberHeavy}`
        //`${left}, ${top}, ${leftMoved}, ${topMoved}, ${gridNumber}, ${gridNumberHeavy}`
        `REAL: (${leftMoved}, ${topMoved}), ${gridNumber}, ${gridNumberHeavy}, GUESS: (${leftMovedGuess}, ${topMovedGuess})`
      );
      //console.log(gridNumberHeavy);
    }, 10);
  });
